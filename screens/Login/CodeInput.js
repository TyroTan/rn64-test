// https://github.com/ttdung11t2/react-native-confirmation-code-input/blob/master/components/ConfirmationCodeInput.js
/*
 *
 * forked so it can be disabled on fulfill/loading
 * and unfocused
 *
 */
...
export default class ConfirmationCodeInput extends Component {
  static propTypes = {
    ...
    unfocusOnFulfill: PropTypes.bool,
  ...
  clear() {
    ...
    if (!this.props.unfocusOnFulfill) {
      this._setFocus(0);
    }
  }
  ...
  _onInputCode(character, index) {
    ...
    const withDisableOnFulfill =
      (fn) =>
      (..._params) => {
        const returnData = fn(..._params);
        if (unfocusOnFulfill) {
